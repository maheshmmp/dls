/*
 * Created by Ritu Varma G on 11/03/25, 11:41 am
 * varma.ritu@ust.com
 * Last modified 10/14/25, 05:25 pm
 * Copyright (c) 2025.
 * All rights reserved.
 */
...
fun SecondaryButtonScreen(
    ...
    Scaffold(
        topBar = {
            AppBar(
                title = R.string.buttons_secondary,
                drawerState = drawerState,
                navigationIcon = {
        ...
        CoreBackground {
            Column(
                ...
                SecondaryButtons(isFillMaxWidth = isFillWidthEnabled)
            }
        }
    }
}
...
@Composable
fun ChangerSwitchLayout(
    displayText: String? = "",
    onCheckedChange: (Boolean) -> Unit
) {
    var isSwitchEnabled by remember { mutableStateOf(false) } // internal state to control switch UI
    Row(
        modifier =
            Modifier
                .wrapContentSize()
        ...
        Text(
            ...
            modifier = Modifier.padding(end = UICSpacing.spacing.spacing050),
        ...
        Switch(
            ...
            colors =
                SwitchDefaults.colors(
                    ...
                    uncheckedThumbColor = UICTheme.colorScheme.neutral.white,
                    checkedTrackColor = UICTheme.colorScheme.brand.interactive.core,
                    uncheckedTrackColor = UICTheme.colorScheme.neutral.gray2,
                ),
        )
    }
}
...
@Composable
fun SecondaryButtons(isFillMaxWidth: Boolean) {
