...
import com.heb.centralmarket.uicart.component.UICCircularLoadingIndicator
import com.heb.centralmarket.uicart.icons.chevronLeft
import com.heb.centralmarket.uicart.themesystem.UICTheme

@Composable
fun CircularLoadingIndicatorScreen(
    ...
    Scaffold(
        topBar = {
            AppBar(
                title = R.string.circular_loading_indicator_title,
                drawerState = drawerState,
                navigationIcon = {
