...
fun ActionsScreen(
    ...
    Scaffold(
        topBar = {
            AppBar(title = R.string.actions, drawerState = drawerState, navigationIcon = {
                            ...
                            ListItem(
                                modifier = Modifier
                                    ...
                                    .clickable {
                                        when (category) {
                                            R.string.toggle_button ->
                                                navController.navigate(MainNavOption.ToggleButton.name)

                                            R.string.radio_button ->
                                                navController.navigate(MainNavOption.RadioButtonScreen.name)
