 ...
 * @param secondaryText The text for the secondary action button.
 * @param isLoading If true, disables buttons and shows loading state on the primary button.
 * @param onPrimaryClick Callback invoked when the primary button is clicked.
 * @param onSecondaryClick Callback invoked when the secondary button is clicked.
 */
@Composable
fun DualActionContent(
    title: String,
    message: String,
    primaryText: String,
